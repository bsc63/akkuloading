...
If you enter the data for only one battery, the app calculates the charging time and notifies you when the battery is fully charged—so you can, for example, plug in the second battery.
If you enter the values for both batteries, the app calculates the charging time for simultaneous charging via the splitter.
